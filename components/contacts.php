...
<?php foreach ($contacts as $contact): ?>
    <a href="<?= $contact['link'] ?>" target="_blank" class="flex gap-[12px] items-center p-5 bg-[#292C34] rounded-lg border-2 border-[#292C34] transition-all hover:border-blue-500">
